...
It is highly recommended after completing these steps that you do remove the command from ```lation_chopshop/server/functions.lua``` file found on line(s) 153-214.
