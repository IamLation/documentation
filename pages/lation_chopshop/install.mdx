---
title: Chop Shop - Install
description: Step by step instructions to install Chop Shop
---
...
<Callout type="info" emoji="ℹ️">
    An interaction script is also required, such as ```ox_target``` or ```qb-target```
</Callout>
...
* Open ```server.cfg``` and add ```start``` or ```ensure lation_chopshop```
* Restart your server
