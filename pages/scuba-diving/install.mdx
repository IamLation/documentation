...
<Tabs items={['ox_inventory', 'qb-inventory', 'qs-inventory']}>
  ...
  <Tabs.Tab>
    * Copy items from ```/install/items/qs-inventory.txt``` into ```qs-inventory/shared/items.lua```
    * Copy images from ```/install/images``` into ```qs-inventory/html/images```
    ```lua
    -- Item data format for qs-inventory
    ['ls_scuba_gear_1'] = {
        ['name'] = 'ls_scuba_gear_1',
        ['label'] = 'Scuba Gear',
        ['weight'] = 4000,
        ['type'] = 'item',
        ['image'] = 'ls_scuba_gear_1.png',
        ['unique'] = true,
        ['useable'] = true,
        ['shouldClose'] = true,
        ['combinable'] = nil,
